...
export default function ProblemPage() {
  ...
  return (
    <div className="min-h-screen  bg-black text-white my-12 max-w-6xl mx-auto">
      <a href="/problems" className="my-16 underline underline-offset-6 hover:text-blue-500 transition-all duration-200">Back to Problems</a>
      <div className="flex items-start justify-between mt-12 mx-auto">
        <div className="w-3/5">
        ...
        <div className="">
          ...
          <div className="mt-10 border border-white/20 rounded-lg p-6">
            ...
            <button
              disabled={submitting}
              onClick={submit}
              className={`mt-6 cursor-pointer w-full px-6 py-2 rounded-lg font-semibold transition
              ${
                submitting
